...
(function() {
    ...
    function bindFilterEvents() {
        ...
        filterContainer.addEventListener('change', function(e) {
            if (e.target.type === 'checkbox') {
                ...
                const text = label.querySelector('span.active') || label.querySelector('span');
    ...
    function addFilter(value) {
        ...
        const categoryLabels = ['Chăm Sóc Răng Miệng', 'Chăm sóc da', 'Dụng cụ y tế', 'Thực phẩm chức năng', 'Chăm sóc tóc'];
    ...
    function resetFilters() {
        ...
        const checkboxes = document.querySelectorAll(CONFIG.filterContainerSelector + ' input[type="checkbox"]');
